...
type TrafficProps = {
  upTrafficColor?: string;
  downTrafficColor?: string;
};

/**
 * draw the traffic graph
 */
export const TrafficGraph = forwardRef<TrafficRef, TrafficProps>(
  (props, ref) => {
    ...
    useEffect(() => {
      ...
      const upLineColor = props.upTrafficColor || secondary.main || "#9c27b0";
      const downLineColor = props.downTrafficColor || primary.main || "#5b5c9d";
